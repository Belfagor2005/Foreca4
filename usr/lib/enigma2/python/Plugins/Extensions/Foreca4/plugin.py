...
class ForecaPreview_4(Screen, HelpableScreen):
    ...
    def my_forecast_weather(self):
        ...
        while n <= i - 1:
            ...
            try:
                f_w_s = str(mywindSpeed(f_wind_speed[n], for_wind_speed_recalc)) + ' ' + _('km/h')
            except:
                f_w_s = '0.00' + _('km/h')
...
class Color_Select(Screen):
    ...
    def start_background_translation(self):
        ...
        def translate():
            ...
            if translated_count > 0:
                print(f"[Color_Select] Background: tradotti {translated_count} elementi")
                self.update_gui()
    ...
    def translate_color(self, russian_name):
        ...
        try:
            if '-' in russian_name:
                ...
                print(f"[Color_Select] Result with iphen: '{russian_name}' -> '{result}'")
                return result
    ...
    def translate_current_page(self):
        ...
        def translate_page():
            ...
            print(f"[Color_Select] Translating page: indices {page_start} to {page_end}")
            translated_any = False
